(function () {
  ...
  const translations = {
    it: {
      ...
      "contact.github.hint": "Qui trovi codice, prove e progetti pubblicati.",
      "contact.instagram.hint": "Se preferisci, ci sentiamo anche qui.",
    ...
    en: {
      ...
      "contact.github.hint": "You can find my code, experiments, and published work here.",
      "contact.instagram.hint": "If you prefer, you can message me here too.",
